...
2. Prover
User generates a Zero-Knowledge Proof proving ownership of the private key
3. Verifier
Server verifies the proof
Checks if the public key is authorized
4. Access Control
Access is granted only if the role has permission
...
Verifier validates proof without seeing private key
🔐 Authorization Check
